...
public class UniqueElements {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(unique)); //2,4,6 are unique because they appear only once

        //double[] array
        double[] array2 = {1.5, 2.5, 2.5, 1.5, 3.5, 4.5, 5.5, 5.5};

        double[] unique2 = uniqueElements(array2);

        System.out.println(Arrays.toString(unique2)); //3.5, 4.5 are unique because they appear only once
