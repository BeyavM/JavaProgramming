...
public class StringUtility {
    ...
    //reverses the given String and returns the reversed String (ex: "Java" -> "avaJ")
    ...
    //remove the duplicates from given string, returns String (ex: "aaaaabbbbbccccc" -> "abc")
    public static String removeDuplicates(String str){

        String result = "";

        for (int i = 0; i < str.length(); i++) {
            char each = str.charAt(i); //aaaaaabbbbbbccc
