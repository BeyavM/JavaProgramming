...
public class Student {
        ...
        //example of how we can use a static boolean
        public static boolean isStudent = true;
        public static boolean isHuman = true;

        //we generated a constructor below and changed the this. to set to match out structure
    ...
    //below are our getters we created ( getName(), getAge() ) getters are read-only
        ...
        //below are out setters we created ( setName(String name), setAge(int age) )
        ...
        //toString method allows us to print out statements we created
